Procedural Cable Static v1.1
DrinkingWindGames



NOTE:  All you need from the downloaded asset package is "CableProceduralCurve"



How To Use:

1.	Attach "CableProceduralStatic" component to an empty, a lineRenderer will be automatically added.
...
4.	Assign the CableProceduralStatic's values as desired:
