...
[System.Serializable]
public class Quest12CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest12 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta12";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest12CameraData data = JsonUtility.FromJson<Quest12CameraData>(json);
