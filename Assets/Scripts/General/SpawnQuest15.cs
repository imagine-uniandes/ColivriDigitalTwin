...
[System.Serializable]
public class Quest15CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest15 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta15";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest15CameraData data = JsonUtility.FromJson<Quest15CameraData>(json);
