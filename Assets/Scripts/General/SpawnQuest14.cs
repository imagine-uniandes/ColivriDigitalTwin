...
[System.Serializable]
public class Quest14CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest14 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta14";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest14CameraData data = JsonUtility.FromJson<Quest14CameraData>(json);
