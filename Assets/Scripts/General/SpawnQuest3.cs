...
public class SpawnQuest3 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta3";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest3CameraData data = JsonUtility.FromJson<Quest3CameraData>(json);
