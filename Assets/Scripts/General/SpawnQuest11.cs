...
[System.Serializable]
public class Quest11CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest11 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta11";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest11CameraData data = JsonUtility.FromJson<Quest11CameraData>(json);
