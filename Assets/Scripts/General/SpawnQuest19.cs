...
[System.Serializable]
public class Quest19CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest19 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta19";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest19CameraData data = JsonUtility.FromJson<Quest19CameraData>(json);
