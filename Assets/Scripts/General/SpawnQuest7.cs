...
public class SpawnQuest7 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta7";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest7CameraData data = JsonUtility.FromJson<Quest7CameraData>(json);
