...
[System.Serializable]
public class Quest27CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest27 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta27";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest27CameraData data = JsonUtility.FromJson<Quest27CameraData>(json);
