...
[System.Serializable]
public class Quest22CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest22 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta22";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest22CameraData data = JsonUtility.FromJson<Quest22CameraData>(json);
