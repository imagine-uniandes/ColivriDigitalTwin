...
public class SpawnQuest8 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta8";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest8CameraData data = JsonUtility.FromJson<Quest8CameraData>(json);
