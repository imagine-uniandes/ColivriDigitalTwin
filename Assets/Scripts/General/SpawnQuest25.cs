...
[System.Serializable]
public class Quest25CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest25 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta25";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest25CameraData data = JsonUtility.FromJson<Quest25CameraData>(json);
