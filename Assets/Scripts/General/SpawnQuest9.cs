...
public class SpawnQuest9 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta9";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest9CameraData data = JsonUtility.FromJson<Quest9CameraData>(json);
