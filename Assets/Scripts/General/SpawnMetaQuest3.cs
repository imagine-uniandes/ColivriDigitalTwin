...
[System.Serializable]
public class MetaQuest3CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnMetaQuest3 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/quest3";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                MetaQuest3CameraData data = JsonUtility.FromJson<MetaQuest3CameraData>(json);
