...
[System.Serializable]
public class Quest24CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest24 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta24";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest24CameraData data = JsonUtility.FromJson<Quest24CameraData>(json);
