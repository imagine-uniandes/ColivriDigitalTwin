...
[System.Serializable]
public class Quest18CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest18 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta18";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest18CameraData data = JsonUtility.FromJson<Quest18CameraData>(json);
