...
[System.Serializable]
public class HololensACameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnHololensA : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/holopa";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                HololensACameraData data = JsonUtility.FromJson<HololensACameraData>(json);
