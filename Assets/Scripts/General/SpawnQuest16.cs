...
[System.Serializable]
public class Quest16CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest16 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta16";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest16CameraData data = JsonUtility.FromJson<Quest16CameraData>(json);
