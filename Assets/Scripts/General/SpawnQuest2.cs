...
public class SpawnQuest2 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta2";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest2CameraData data = JsonUtility.FromJson<Quest2CameraData>(json);
