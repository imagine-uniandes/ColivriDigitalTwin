...
[System.Serializable]
public class Quest26CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest26 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta26";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest26CameraData data = JsonUtility.FromJson<Quest26CameraData>(json);
