...
public class SpawnQuest6 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta6";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest6CameraData data = JsonUtility.FromJson<Quest6CameraData>(json);
