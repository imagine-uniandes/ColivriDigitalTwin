...
[System.Serializable]
public class Quest29CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest29 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta29";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest29CameraData data = JsonUtility.FromJson<Quest29CameraData>(json);
