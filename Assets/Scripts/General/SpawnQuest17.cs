...
[System.Serializable]
public class Quest17CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest17 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta17";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest17CameraData data = JsonUtility.FromJson<Quest17CameraData>(json);
