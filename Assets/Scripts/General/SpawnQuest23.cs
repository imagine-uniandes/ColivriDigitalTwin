...
[System.Serializable]
public class Quest23CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest23 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta23";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest23CameraData data = JsonUtility.FromJson<Quest23CameraData>(json);
