...
[System.Serializable]
public class Quest21CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest21 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta21";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest21CameraData data = JsonUtility.FromJson<Quest21CameraData>(json);
