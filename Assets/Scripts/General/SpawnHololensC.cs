...
[System.Serializable]
public class HololensCCameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnHololensC : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/holopc";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                HololensCCameraData data = JsonUtility.FromJson<HololensCCameraData>(json);
