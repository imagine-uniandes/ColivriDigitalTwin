...
[System.Serializable]
public class Quest13CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest13 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta13";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest13CameraData data = JsonUtility.FromJson<Quest13CameraData>(json);
