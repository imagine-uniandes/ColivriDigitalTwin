...
[System.Serializable]
public class Quest10CameraData
{
    public float x;
    public float y;
    public float z;
...
public class SpawnQuest10 : MonoBehaviour
{
    ...
    private string serverURL = "http://172.24.100.110:8080/data/meta10";
    ...
    IEnumerator UpdateObjectPosition()
    {
        while (true)
        {
            ...
            if (request.result == UnityWebRequest.Result.Success)
            {
                ...
                Quest10CameraData data = JsonUtility.FromJson<Quest10CameraData>(json);
